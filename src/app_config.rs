...
const BASE_PATH_DIR_NAME: &str = "ggldrive3";
    ...
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Error::AccountConfigMissing => {
                ...
                writeln!(f, "Use `ggldrive account list` to show all accounts.")?;
                write!(f, "Use `ggldrive account switch` to select an account.")
            }
