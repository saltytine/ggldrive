...
pub async fn add() -> Result<(), Error> {
    ...
    println!("Instructions for how to create credentials can be found here: https://github.com/saltytine/ggldrive/blob/main/docs/create_google_api_credentials.md");
    println!();
